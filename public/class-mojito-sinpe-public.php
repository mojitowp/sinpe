...
class Mojito_Sinpe_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Mojito_Sinpe_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Mojito_Sinpe_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mojito-sinpe-public.css', array(), $this->version, 'all' );
	}
